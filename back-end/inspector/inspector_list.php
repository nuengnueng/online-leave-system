    ...
    <div class="container">
        ...
        <tr>
           ...
           <td><?php echo $data['lastname']?></td>
            ...
            <td><a href="inspector_edit.php?id=<?=$data['id']?>" class="btn btn-warning ">อนุญาต</a></td>
            <td><a href="inspector_delete.php?id=<?=$data['id']?>"class="btn btn-danger ">ไม่อนุญาต</a></td>  
