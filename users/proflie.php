...
<div class="formbold-main-wrapper">
  ...
  <div class="display-6 text-center justify-content-center ">แก้ไขโปรไฟล์</div><br>
      ...
      <div class="formbold-input-flex">
        ...
        <div>
          ...
          <option value="Mrs"<?php if($row['nametitle']=="Mrs"){echo"selected";}?>>นาง</option>
            ...
            <option value="pfc" <?php if($row['nametitle']=="pfc"){echo"selected";}?>>สิบตรี</option>
            <option value="capt" <?php if($row['nametitle']=="capt"){echo"selected";}?>>ร้อยเอก</option>
            <option value="Sub lt" <?php if($row['nametitle']=="Sub lt"){echo"selected";}?>>ร้อยตรี</option>
            <option value="mom luang" <?php if($row['nametitle']=="mom luang"){echo"selected";}?>>หม่อมหลวง</option>
            <option value="mom rajawong" <?php if($row['nametitle']=="mom rajawong"){echo"selected";}?>>หม่อมราชวงศ์</option>
            <option value="mom chao" <?php if($row['nametitle']=="mom chao"){echo"selected";}?>>หม่อมเจ้า</option>
            <option value="professor" <?php if($row['nametitle']=="professor"){echo"selected";}?>>ศาสตราจารย์</option>
            <option value="assistat professor" <?php if($row['nametitle']=="assistat professor"){echo"selected";}?>>ผู้ช่วยศาสตราจารย์</option>
            <option value="associate professor" <?php if($row['nametitle']=="associate professor"){echo"selected";}?>>รองศาสตราจารย์</option>
            </select>
        </div>
      </div>
