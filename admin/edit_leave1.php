...
$id = $_GET['id'];
$sql = "SELECT*FROM leave_type1 WHERE id = '$id'";
...
if(isset($_POST) && !empty($_POST)){
    ...
    $sql_edit = "UPDATE leave_type1 SET id ='$id',leave_name ='$leave_name',leave_limit='$leave_limit'
                                      WHERE id =
                                     '$id' ";
...
<div class="formbold-main-wrapper">
  ...
  <div class="display-4 text-center justify-content-center ">แก้ไขข้อมูล</div>
