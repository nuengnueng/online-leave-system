            ...
            $num = 0;
                 foreach ($query as $data) { 
                    ...
                    <tr>
                        ...
                        <td><a href="leave_delete1.php?id=<?= $data['id'] ?>"class="btn btn-danger btn-sm"data-bs-toggle="modal" data-bs-target="#modalCart<?php echo $data['id']?>">ลบ</a></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="leave_delete1.php?id=<?=$data['id']?>"class="btn btn-danger btn-sm" >ตกลง</a>
      </div>
    </div>
  </div>
</div>
